## Etapa 29 — Executar a revisão final com o custom agent

Abra o Copilot Chat em uma **nova sessão**, selecione manualmente o custom agent **Revisor da entrega** e execute este prompt:
...
Selecione como contexto:

- `docs/specs/training-catalog-vertical-slice.md`;
- o teste principal;
- os arquivos da API que configuram o OpenAPI e declaram os endpoints e suas respostas;
