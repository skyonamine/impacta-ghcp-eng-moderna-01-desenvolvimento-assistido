## Etapa 4 — Explorar respostas de erro com few-shot

Agora vamos repetir o mesmo problema, mas com contrato e exemplos mais explícitos.

Abra o Copilot Chat em uma **nova sessão** e use o modo **Ask**, usando o mesmo modelo e o mesmo contexto geral da etapa anterior.
...
Compare o resultado com o da etapa anterior. O objetivo é perceber como o formato esperado fica mais explícito.
