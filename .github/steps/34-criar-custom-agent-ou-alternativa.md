# Passo 34 - Criar o custom agent ou usar a alternativa (Slide 30)

Depois de revisar o perfil, vamos registrá-lo no repositório e confirmar que o VS Code consegue descobri-lo.

Continue na **mesma sessão**, em modo **Agent**. Se a criação ao vivo falhar, crie `.github/agents/revisor-entrega.md` usando somente o **Arquivo de referência** do exemplo. Confirme **Revisor da entrega** no seletor.
