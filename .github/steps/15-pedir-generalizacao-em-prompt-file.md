# Passo 15 - Explicitar a nova regra de `startDate` (Slide 13)

O teste revelou uma expectativa sobre datas duplicadas. Antes de chamar isso de defeito, vamos tornar a nova regra explícita e rastreável.

Continue na **mesma sessão** no modo **Agent**. O agente deve distinguir comportamento inesperado de defeito e parar antes de editar.
