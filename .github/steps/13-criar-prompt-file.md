## Etapa 13 — Criar ou revisar o prompt file
...
```text
.github/prompts/criar-endpoint-treinamento.prompt.md
```

Se quiser comparar com a versão ensaiada, use este conteúdo de referência:
