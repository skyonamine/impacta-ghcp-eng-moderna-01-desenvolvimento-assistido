## Etapa 2 — Explorar ambiguidades do cenário

Agora vamos usar o Copilot para revelar decisões abertas antes de falar de arquitetura ou código.
...
Guarde a resposta. Ela será usada como insumo nas próximas etapas.
